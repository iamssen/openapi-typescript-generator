...
import { DailySubObjAllOf, SubObj, SubObjType } from './';

/**
 *
 * @interface DailySubObj
 */
export interface DailySubObj extends SubObj {
  /**
   *
   * @type {number}
   * @memberof DailySubObj
   */
  dayOfMonth?: number;
}

export const DailySubObjModel: GenericModel = {
  classname: 'DailySubObj',
  type: 'generic',
  parent: 'SubObj',
  vars: {
    dayOfMonth: [
