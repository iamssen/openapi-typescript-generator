...
export const SpecialModelNameModel: GenericModel = {
  classname: 'SpecialModelName',
  type: 'generic',
  parent: undefined,
  vars: {
    $specialPropertyName: [
      '$specialPropertyName', // name
      '$special[property.name]', // baseName
      'number', // datatype
      false, // required
  ...
  baseNames: {
    $specialPropertyName: '$special[property.name]',
  },
};
