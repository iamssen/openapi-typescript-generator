...
import type { Client, OuterComposite, User } from '../models';
...
export interface HyphenParamRequestParameters {
  hyphenParam: string;
}
 ...
 */
export const _123exampleRequest = ({
  basePath = '',
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const _123exampleResponse = (
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function _123example(
  configuration: OperationConfiguration = {},
): Promise<void> {
  return pipe(
    _123exampleRequest(configuration),
    fetchRequest(configuration),
    _123exampleResponse(configuration),
  )();
}
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const fakeResponseWithNumericalDescriptionRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const fakeResponseWithNumericalDescriptionResponse = (
  configuration: ResponseConfiguration = {},
) => async (response: Response): Promise<void> => {
  if (response.status >= 200 && response.status < 300) {
  } else {
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function fakeResponseWithNumericalDescription(
  configuration: OperationConfiguration = {},
): Promise<void> {
  return pipe(
    fakeResponseWithNumericalDescriptionRequest(configuration),
    fetchRequest(configuration),
    fakeResponseWithNumericalDescriptionResponse(configuration),
  )();
}
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const hyphenParamRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
  ...
  requestParameters: HyphenParamRequestParameters,
): FetchParameters => {
  if (
    requestParameters.hyphenParam === null ||
    requestParameters.hyphenParam === undefined
  ) {
    throw new APIRequestError(
      `Required parameter requestParameters.hyphenParam was null or undefined when calling hyphenParam.`,
    );
  }
  ...
  let url: string = `${basePath.replace(
    /\/+$/,
    '',
  )}/fake/hyphenParam/{hyphen-param}`.replace(
    `{${'hyphen-param'}}`,
    encodeURIComponent(String(requestParameters.hyphenParam)),
  );
  if (queryParameters && Object.keys(queryParameters).length > 0) {
    url += '?' + querystringStringify(queryParameters);
  }
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const hyphenParamResponse = (
  configuration: ResponseConfiguration = {},
) => async (response: Response): Promise<void> => {
  if (response.status >= 200 && response.status < 300) {
  } else {
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function hyphenParam(
  requestParameters: HyphenParamRequestParameters,
  configuration: OperationConfiguration = {},
): Promise<void> {
  return pipe(
    hyphenParamRequest(configuration),
    fetchRequest(configuration),
    hyphenParamResponse(configuration),
  )(requestParameters);
}
