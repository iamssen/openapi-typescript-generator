 ...
 */
export const fileresponsetestRequest = ({
  basePath = '',
  ...
  let url: string = `${basePath.replace(/\/+$/, '')}/tests/fileResponse`;
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const fileresponsetestResponse = (
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function fileresponsetest(
  configuration: OperationConfiguration = {},
): Promise<Blob> {
  return pipe(
    fileresponsetestRequest(configuration),
    fetchRequest(configuration),
    fileresponsetestResponse(configuration),
  )();
}
