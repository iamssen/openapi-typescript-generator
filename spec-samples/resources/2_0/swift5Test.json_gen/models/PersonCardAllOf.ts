...
/**
 *
 * @interface PersonCardAllOf
 */
export interface PersonCardAllOf {
  /**
   *
   * @type {string}
   * @memberof PersonCardAllOf
   */
  firstName?: string;
...
export const PersonCardAllOfModel: GenericModel = {
  classname: 'PersonCardAllOf',
  type: 'generic',
  parent: undefined,
  vars: {
    firstName: [
