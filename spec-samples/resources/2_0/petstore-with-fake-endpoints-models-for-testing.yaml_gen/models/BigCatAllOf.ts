...
/**
 *
 * @interface BigCatAllOf
 */
export interface BigCatAllOf {
  /**
   *
   * @type {string}
   * @memberof BigCatAllOf
   */
  kind?: BigCatAllOfKindEnum;
}

export const BigCatAllOfModel: GenericModel = {
  classname: 'BigCatAllOf',
  type: 'generic',
  parent: undefined,
  vars: {
    kind: [
 ...
 * @enum {string}
 */
export enum BigCatAllOfKindEnum {
  Lions = 'lions',
  Tigers = 'tigers',
  Leopards = 'leopards',
  Jaguars = 'jaguars',
