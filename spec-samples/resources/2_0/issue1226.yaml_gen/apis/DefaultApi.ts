...
import type { NumberHolder } from '../models';
import { typeSerializer } from '../runtime';

/* eslint-disable */

/**
 * Get back a NumberHolder
...
) => async (response: Response): Promise<NumberHolder> => {
  if (response.status >= 200 && response.status < 300) {
    return response.json().then(typeSerializer.toValueObject('NumberHolder'));
  } else {
