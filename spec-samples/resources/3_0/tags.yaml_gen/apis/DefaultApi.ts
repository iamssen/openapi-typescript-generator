...
export const op4Request = ({
  ...
  let url: string = `${basePath.replace(/\/+$/, '')}/group3/op4`;
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function op4(
  configuration: OperationConfiguration = {},
): Promise<void> {
  return pipe(
    op4Request(configuration),
    fetchRequest(configuration),
    op4Response(configuration),
  )();
}
