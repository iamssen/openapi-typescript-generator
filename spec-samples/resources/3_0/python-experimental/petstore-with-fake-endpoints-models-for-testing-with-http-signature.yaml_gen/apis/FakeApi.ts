...
export interface AdditionalPropertiesWithArrayOfEnumsRequestParameters {
  requestBody?: { [key: string]: Array<EnumClass> };
}
export interface ArrayModelRequestParameters {
  body?: Array<Animal>;
}
export interface ArrayOfEnumsRequestParameters {
  stringEnum?: Array<StringEnum>;
}
export interface ComposedOneOfNumberWithValidationsRequestParameters {
  numberAnimalNullDate?: number | Animal | Null | Date;
}
export interface MammalRequestParameters {
  mammal: Mammal;
}
...
export interface TestQueryParameterCollectionFormatRequestParameters {
  pipe: Array<string>;
  ioutil: Array<string>;
  http: Array<string>;
  url: Array<string>;
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const additionalPropertiesWithArrayOfEnumsRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
  ...
  requestParameters: AdditionalPropertiesWithArrayOfEnumsRequestParameters,
): FetchParameters => {
  const queryParameters: UrlQueryInput = {};
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const additionalPropertiesWithArrayOfEnumsResponse = (
  configuration: ResponseConfiguration = {},
) => async (
  response: Response,
): Promise<{ [key: string]: Array<EnumClass> }> => {
  if (response.status >= 200 && response.status < 300) {
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function additionalPropertiesWithArrayOfEnums(
  requestParameters: AdditionalPropertiesWithArrayOfEnumsRequestParameters,
  configuration: OperationConfiguration = {},
): Promise<{ [key: string]: Array<EnumClass> }> {
  return pipe(
    additionalPropertiesWithArrayOfEnumsRequest(configuration),
    fetchRequest(configuration),
    additionalPropertiesWithArrayOfEnumsResponse(configuration),
  )(requestParameters);
}
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const arrayOfEnumsRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
  ...
  requestParameters: ArrayOfEnumsRequestParameters,
): FetchParameters => {
  const queryParameters: UrlQueryInput = {};
  ...
  let url: string = `${basePath.replace(/\/+$/, '')}/fake/refs/array-of-enums`;
  if (queryParameters && Object.keys(queryParameters).length > 0) {
    url += '?' + querystringStringify(queryParameters);
  }

  const body = JSON.stringify(
    requestParameters.stringEnum?.map(
      typeSerializer.toJsonObject('StringEnum'),
    ),
  );
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const arrayOfEnumsResponse = (
  configuration: ResponseConfiguration = {},
) => async (response: Response): Promise<Array<StringEnum>> => {
  if (response.status >= 200 && response.status < 300) {
    return response.json().then(typeSerializer.toValueObjectList('StringEnum'));
  } else {
    switch (response.status.toString()) {
      default:
        throw response;
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function arrayOfEnums(
  requestParameters: ArrayOfEnumsRequestParameters,
  configuration: OperationConfiguration = {},
): Promise<Array<StringEnum>> {
  return pipe(
    arrayOfEnumsRequest(configuration),
    fetchRequest(configuration),
    arrayOfEnumsResponse(configuration),
  )(requestParameters);
}
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const composedOneOfNumberWithValidationsRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
  ...
  requestParameters: ComposedOneOfNumberWithValidationsRequestParameters,
): FetchParameters => {
  const queryParameters: UrlQueryInput = {};
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('number | Animal | Null | Date')(
      requestParameters.numberAnimalNullDate,
    ),
  );
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const composedOneOfNumberWithValidationsResponse = (
  configuration: ResponseConfiguration = {},
) => async (
  response: Response,
): Promise<ComposedOneOfNumberWithValidations> => {
  if (response.status >= 200 && response.status < 300) {
    return response
      .json()
      .then(typeSerializer.toValueObject('ComposedOneOfNumberWithValidations'));
  } else {
    switch (response.status.toString()) {
      default:
        throw response;
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function composedOneOfNumberWithValidations(
  requestParameters: ComposedOneOfNumberWithValidationsRequestParameters,
  configuration: OperationConfiguration = {},
): Promise<ComposedOneOfNumberWithValidations> {
  return pipe(
    composedOneOfNumberWithValidationsRequest(configuration),
    fetchRequest(configuration),
    composedOneOfNumberWithValidationsResponse(configuration),
  )(requestParameters);
}
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const fakeHealthGetRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
  ...
  let url: string = `${basePath.replace(/\/+$/, '')}/fake/health`;
  if (queryParameters && Object.keys(queryParameters).length > 0) {
    url += '?' + querystringStringify(queryParameters);
  }
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const fakeHealthGetResponse = (
  configuration: ResponseConfiguration = {},
) => async (response: Response): Promise<HealthCheckResult> => {
  if (response.status >= 200 && response.status < 300) {
    return response
      .json()
      .then(typeSerializer.toValueObject('HealthCheckResult'));
  } else {
    switch (response.status.toString()) {
      default:
        throw response;
...
export async function fakeHealthGet(
  ...
  return pipe(
    fakeHealthGetRequest(configuration),
    fetchRequest(configuration),
    fakeHealthGetResponse(configuration),
  )();
}
...
export const mammalRequest = ({
  ...
  requestParameters: MammalRequestParameters,
): FetchParameters => {
  if (
    requestParameters.mammal === null ||
    requestParameters.mammal === undefined
  ) {
    throw new APIRequestError(
      `Required parameter requestParameters.mammal was null or undefined when calling mammal.`,
    );
  }
  ...
  let url: string = `${basePath.replace(/\/+$/, '')}/fake/refs/mammal`;
  if (queryParameters && Object.keys(queryParameters).length > 0) {
    url += '?' + querystringStringify(queryParameters);
  }

  const body = JSON.stringify(
    typeSerializer.toJsonObject('Mammal')(requestParameters.mammal),
  );
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const mammalResponse = (
  configuration: ResponseConfiguration = {},
) => async (response: Response): Promise<Mammal> => {
  if (response.status >= 200 && response.status < 300) {
    return response.json().then(typeSerializer.toValueObject('Mammal'));
  } else {
    switch (response.status.toString()) {
      default:
        throw response;
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function mammal(
  requestParameters: MammalRequestParameters,
  configuration: OperationConfiguration = {},
): Promise<Mammal> {
  return pipe(
    mammalRequest(configuration),
    fetchRequest(configuration),
    mammalResponse(configuration),
  )(requestParameters);
}
...
export const testBodyWithFileSchemaRequest = ({
  ...
  if (
    requestParameters.fileSchemaTestClass === null ||
    requestParameters.fileSchemaTestClass === undefined
  ) {
    throw new APIRequestError(
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('FileSchemaTestClass')(
      requestParameters.fileSchemaTestClass,
    ),
  );
...
export const testBodyWithQueryParamsRequest = ({
  ...
  if (requestParameters.user === null || requestParameters.user === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.user was null or undefined when calling testBodyWithQueryParams.`,
    );
  }
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('User')(requestParameters.user),
  );
...
export const testClientModelRequest = ({
  ...
  if (
    ...
    throw new APIRequestError(
      `Required parameter requestParameters.client was null or undefined when calling testClientModel.`,
    );
  }
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('Client')(requestParameters.client),
  );
...
export const testEnumParametersRequest = ({
  ...
  if (requestParameters.enumQueryStringArray) {
    queryParameters['enum_query_string_array'] =
      requestParameters.enumQueryStringArray;
  }
...
export const testInlineAdditionalPropertiesRequest = ({
  ...
  if (
    ...
    throw new APIRequestError(
      `Required parameter requestParameters.requestBody was null or undefined when calling testInlineAdditionalProperties.`,
    );
  }
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const testQueryParameterCollectionFormatRequest = ({
  basePath = '',
  querystringStringify = querystring,
  username,
  password,
  ...
  requestParameters: TestQueryParameterCollectionFormatRequestParameters,
): FetchParameters => {
  if (requestParameters.pipe === null || requestParameters.pipe === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.pipe was null or undefined when calling testQueryParameterCollectionFormat.`,
    );
  }
  if (
    requestParameters.ioutil === null ||
    requestParameters.ioutil === undefined
  ) {
    throw new APIRequestError(
      `Required parameter requestParameters.ioutil was null or undefined when calling testQueryParameterCollectionFormat.`,
    );
  }
  if (requestParameters.http === null || requestParameters.http === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.http was null or undefined when calling testQueryParameterCollectionFormat.`,
    );
  }
  if (requestParameters.url === null || requestParameters.url === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.url was null or undefined when calling testQueryParameterCollectionFormat.`,
    );
  }
  if (
    requestParameters.context === null ||
    requestParameters.context === undefined
  ) {
    throw new APIRequestError(
      `Required parameter requestParameters.context was null or undefined when calling testQueryParameterCollectionFormat.`,
    );
  }
  ...
  if (requestParameters.ioutil) {
    queryParameters['ioutil'] = requestParameters.ioutil.join(
      collectionFormats['csv'],
    );
  }
  if (requestParameters.http) {
    queryParameters['http'] = requestParameters.http.join(
      collectionFormats['ssv'],
    );
  }
  if (requestParameters.url) {
    queryParameters['url'] = requestParameters.url.join(
      collectionFormats['csv'],
    );
  }
  ...
  let url: string = `${basePath.replace(/\/+$/, '')}/fake/test-query-paramters`;
  if (queryParameters && Object.keys(queryParameters).length > 0) {
    url += '?' + querystringStringify(queryParameters);
  }
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const testQueryParameterCollectionFormatResponse = (
  configuration: ResponseConfiguration = {},
) => async (response: Response): Promise<void> => {
  if (response.status >= 200 && response.status < 300) {
  } else {
...
export async function testQueryParameterCollectionFormat(
  ...
  return pipe(
    testQueryParameterCollectionFormatRequest(configuration),
    fetchRequest(configuration),
    testQueryParameterCollectionFormatResponse(configuration),
  )(requestParameters);
}
