...
import type { NonStrippedRequest, Response } from '../models';
import { typeSerializer } from '../runtime';

/* eslint-disable */

export interface DeprecatedTestPostRequestParameters {
  nonStrippedRequest?: NonStrippedRequest;
}
...
export const deprecatedTestPostRequest = ({
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('NonStrippedRequest')(
      requestParameters.nonStrippedRequest,
    ),
  );
