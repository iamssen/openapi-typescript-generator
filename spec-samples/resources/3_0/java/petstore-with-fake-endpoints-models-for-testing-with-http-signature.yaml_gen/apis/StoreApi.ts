...
export const placeOrderRequest = ({
  ...
  if (
    ...
    throw new APIRequestError(
      `Required parameter requestParameters.order was null or undefined when calling placeOrder.`,
    );
  }
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('Order')(requestParameters.order),
  );
