...
import { AppleAnyOfDisc, BananaAnyOfDisc } from './';

/**
 *
 * @interface FruitAnyOfDisc
 */
export interface FruitAnyOfDisc {
  /**
   *
   * @type {string}
   * @memberof FruitAnyOfDisc
   */
  fruitType: string;
}

export const FruitAnyOfDiscModel: GenericModel = {
  classname: 'FruitAnyOfDisc',
  type: 'generic',
  parent: undefined,
  discriminator: {
