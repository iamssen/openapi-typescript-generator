...
import { AppleAllOfDisc, BananaAllOfDisc } from './';

/**
 *
 * @interface FruitAllOfDisc
 */
export interface FruitAllOfDisc {
  /**
   *
   * @type {string}
   * @memberof FruitAllOfDisc
   */
  fruitType: string;
}

export const FruitAllOfDiscModel: GenericModel = {
  classname: 'FruitAllOfDisc',
  type: 'generic',
  parent: undefined,
  discriminator: {
