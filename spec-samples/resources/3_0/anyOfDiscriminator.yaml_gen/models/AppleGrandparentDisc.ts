...
/**
 *
 * @interface AppleGrandparentDisc
 */
export interface AppleGrandparentDisc extends Parent {
  /**
   *
   * @type {number}
   * @memberof AppleGrandparentDisc
   */
  seeds: number;
}

export const AppleGrandparentDiscModel: GenericModel = {
  classname: 'AppleGrandparentDisc',
  type: 'generic',
  parent: 'Parent',
  vars: {
    seeds: [
