...
/**
 *
 * @interface FruitInlineDiscAnyOf
 */
export interface FruitInlineDiscAnyOf {
  /**
   *
   * @type {number}
   * @memberof FruitInlineDiscAnyOf
   */
  seeds: number;
...
export const FruitInlineDiscAnyOfModel: GenericModel = {
  classname: 'FruitInlineDiscAnyOf',
  type: 'generic',
  parent: undefined,
  vars: {
    seeds: [
