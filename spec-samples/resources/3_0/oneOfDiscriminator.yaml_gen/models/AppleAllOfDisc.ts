...
/**
 *
 * @interface AppleAllOfDisc
 */
export interface AppleAllOfDisc extends FruitType {
  /**
   *
   * @type {number}
   * @memberof AppleAllOfDisc
   */
  seeds: number;
}

export const AppleAllOfDiscModel: GenericModel = {
  classname: 'AppleAllOfDisc',
  type: 'generic',
  parent: 'FruitType',
  vars: {
    seeds: [
