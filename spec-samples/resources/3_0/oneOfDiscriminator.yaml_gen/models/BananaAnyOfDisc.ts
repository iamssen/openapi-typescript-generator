...
/**
 *
 * @interface BananaAnyOfDisc
 */
export interface BananaAnyOfDisc {
  /**
   *
   * @type {number}
   * @memberof BananaAnyOfDisc
   */
  length: number;
}

export const BananaAnyOfDiscModel: GenericModel = {
  classname: 'BananaAnyOfDisc',
  type: 'generic',
  parent: undefined,
  vars: {
    length: [
