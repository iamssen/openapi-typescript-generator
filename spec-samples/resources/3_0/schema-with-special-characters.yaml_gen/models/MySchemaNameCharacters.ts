...
import { MySchemaNameCharactersAllOf, Parent } from './';
 ...
 * @interface MySchemaNameCharacters
 */
export interface MySchemaNameCharacters extends Parent {
  /**
   *
   * @type {string}
   * @memberof MySchemaNameCharacters
   */
  prop2?: string;
}

export const MySchemaNameCharactersModel: GenericModel = {
  classname: 'MySchemaNameCharacters',
  type: 'generic',
  parent: 'Parent',
  vars: {
    prop2: [
