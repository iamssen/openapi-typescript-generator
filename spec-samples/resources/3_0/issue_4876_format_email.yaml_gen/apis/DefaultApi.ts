...
import type { PersonWithEmail } from '../models';
import { typeSerializer } from '../runtime';

/* eslint-disable */

export interface PersonPutRequestParameters {
  personWithEmail?: PersonWithEmail;
}
...
export const personPutRequest = ({
  ...
  requestParameters: PersonPutRequestParameters,
): FetchParameters => {
  ...
  const body = JSON.stringify(
    typeSerializer.toJsonObject('PersonWithEmail')(
      requestParameters.personWithEmail,
    ),
  );
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export const personPutResponse = (
 ...
 * @throws {APISerializeError} throw when fail serialize data (include request and response)
 */
export async function personPut(
  requestParameters: PersonPutRequestParameters,
  configuration: OperationConfiguration = {},
): Promise<void> {
  return pipe(
    personPutRequest(configuration),
    fetchRequest(configuration),
    personPutResponse(configuration),
  )(requestParameters);
}
