...
export const createUserRequest = ({
  ...
  if (requestParameters.user === null || requestParameters.user === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.user was null or undefined when calling createUser.`,
    );
  }
...
export const createUsersWithArrayInputRequest = ({
  ...
  if (requestParameters.user === null || requestParameters.user === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.user was null or undefined when calling createUsersWithArrayInput.`,
    );
  }
  ...
  const body = JSON.stringify(
    requestParameters.user?.map(typeSerializer.toJsonObject('User')),
  );
...
export const createUsersWithListInputRequest = ({
  ...
  if (requestParameters.user === null || requestParameters.user === undefined) {
    throw new APIRequestError(
      `Required parameter requestParameters.user was null or undefined when calling createUsersWithListInput.`,
    );
  }
