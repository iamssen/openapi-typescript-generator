...
/**
 * additional object
 * @interface MultipartMixedMarker
 */
export interface MultipartMixedMarker {
  /**
   *
   * @type {string}
   * @memberof MultipartMixedMarker
   */
  name?: string;
}

export const MultipartMixedMarkerModel: GenericModel = {
  classname: 'MultipartMixedMarker',
  type: 'generic',
  parent: undefined,
  vars: {
    name: [
