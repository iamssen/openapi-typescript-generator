...
/**
 *
 * @interface DiscriminatedAAllOf
 */
export interface DiscriminatedAAllOf {
  /**
   *
   * @type {string}
   * @memberof DiscriminatedAAllOf
   */
  a?: string;
}

export const DiscriminatedAAllOfModel: GenericModel = {
  classname: 'DiscriminatedAAllOf',
  type: 'generic',
  parent: undefined,
  vars: {
    a: [
